  ...
  $f = {
    ...
    setup(e) {
      ...
      function n() {
        return new URL(
          Object.assign({
            "./assets/video/bank-app.mp4": Of,
            "./assets/video/beats.mp4": Pf,
            "./assets/video/online-shop.webm": Mf,
            "./assets/video/solo-nika.mp4": Sf,
            "./assets/video/todo.mp4": Df,
            "./assets/video/video-production.mp4": Rf,
            "./assets/video/vuelance.mp4": xf,
          })[`./assets/video/${t.videoSrc}`],
          self.location
        );
      }
      const r = Oe(null),
